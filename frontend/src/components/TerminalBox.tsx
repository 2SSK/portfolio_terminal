...
export default function TerminalBox() {
  ...
  return (
    <div className="w-[80%] h-[90%] p-7 border-4 border-primary rounded-lg bg-transparent bg-opacity-30 backdrop-blur-sm shadow-lg shadow-disabled font-jetbrains overflow-y-auto">
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <TerminalInput onSubmit={handleCommandExecution} />
      </Suspense>
    </div>
  );
}
