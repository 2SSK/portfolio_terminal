...
export default function TerminalBox() {
  ...
  return (
    <div
      ...
      className="w-full h-[90%] sm:h-full mb-5 p-4 border-4 border-customBlue rounded-lg bg-[#011423] bg-opacity-50 backdrop-blur-xl shadow-lg shadow-secondary overflow-y-auto overflow-x-hidden"
      ref={outputRef}
    >
      <style>{`
        body {
