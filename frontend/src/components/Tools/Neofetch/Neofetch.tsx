...
const Neofetch: React.FC<NeofetchProps> = ({ PFP }) => {
  return (
    <div className="w-full max-w-2xl  px-4 py-4  bg-opacity-60 rounded-lg hidden md:flex flex-col md:flex-row justify-center md:items-start gap-10 md:gap-[80px] bg-[#1a1b26]">
      <div>
        <img
          src={PFP}
          alt="ASCII Profile"
